...
//    this->model = "/home/taquy/Projects/python/ctr-crop/TestSVM/data-new/train.txt";
    ...
    // create window for slider testing
        ...
        SVMConfig::vals[0] = 9;  this->slider(SVMConfig::vals[0], 200, "Opening", "mask");
        SVMConfig::vals[1] = 0; this->slider(SVMConfig::vals[1], 200, "Closing", "mask");

        SVMConfig::vals[2] = SVMConfig::lower[0]; this->slider(SVMConfig::vals[2], 255, "Lower B", "mask");
        SVMConfig::vals[3] = SVMConfig::lower[1]; this->slider(SVMConfig::vals[3], 255, "Lower R", "mask");
        SVMConfig::vals[4] = SVMConfig::lower[2]; this->slider(SVMConfig::vals[4], 255, "Lower G", "mask");

        SVMConfig::vals[5] = SVMConfig::upper[0]; this->slider(SVMConfig::vals[5], 255, "Upper B", "mask");
        SVMConfig::vals[6] = SVMConfig::upper[1]; this->slider(SVMConfig::vals[6], 255, "Upper R", "mask");
        SVMConfig::vals[7] = SVMConfig::upper[2]; this->slider(SVMConfig::vals[7], 255, "Upper G", "mask");
    #endif
}
...
void filter(Mat &hsv, Mat &mask){
    ...
    #else
    inRange(hsv, Scalar(SVMConfig::vals[2], SVMConfig::vals[3], SVMConfig::vals[4]), Scalar(SVMConfig::vals[5], SVMConfig::vals[6], SVMConfig::vals[7]), mask);
    Mat k(SVMConfig::vals[0], SVMConfig::vals[0], CV_8U, Scalar(1));
    Mat m(SVMConfig::vals[1], SVMConfig::vals[1], CV_8U, Scalar(1));
